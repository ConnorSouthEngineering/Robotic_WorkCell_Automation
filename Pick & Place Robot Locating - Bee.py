...
def EvalEnergy(params):
    robot_x, robot_y, conveyor_x1, conveyor_y1 = params
...
search_boundaries = ([0,0,0,450],[2430,6006,2030,5706])

alg = ba(EvalEnergy,search_boundaries[0],search_boundaries[1])
...
print(f"Robot coordinates: (X: {best.values[0]}, Y: {best.values[1]})")
print(f"Conveyor coordinates: (X1: {best.values[2]}, Y1: {best.values[3]}, X2: {best.values[2]+400}, Y2: {best.values[3]+300} for pickup zone, X1: {best.values[2]}, Y1: {best.values[3]-150}, X2: {best.values[2]+400}, Y2: {best.values[3]-450} for place zone)")
print(f"Energy: {-best.score}")

PlotWorkcell(robot, fixtures, pickup_zone, place_zone, best.values)
